    ...
    <div>
      <AppBar position="static">
        <Toolbar>
          ...
          {this.props.isUserLoggedIn ? <NavLogged triggerView={this.props.triggerView} logOut={this.props.userLogOut} user={this.props.user}/> : <NotLoggedIn userLoggedIn={this.props.userLoggedIn} login={this.props.login} triggerView={this.props.triggerView}/>}
        </Toolbar>
      </AppBar>
    </div>
  );
