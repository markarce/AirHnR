...
class ListingDetails extends React.Component {
    ...
    renderHouseRules () {
        return _.map(this.props.listing.houseRules, (val, key) => {
            if (val) {
                if (key === 'checkIn') {
                    return <li>{`Check-in at ${val}`}</li>
                } else if (key === 'checkOut') {
                    return <li>{`Check-out by ${val}`}</li>
                } else if (key === 'pets') {
                    return <li>Suitable for pets</li>
                } else {
                    return <li>No Smoking</li>
                }
            } else {
                if (key === 'pets') {
                    return <li>Not suitable for pets</li>
                } else {
                    return <li>Smoking Allowed</li>
                }
            }
        });
    }
